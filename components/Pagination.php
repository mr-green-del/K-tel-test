<?php
    ...
    class Pagination
    {
        ...
        private function generateHtml($arrows, $displayedLinks, $path, $numPages)
        {
            ...
            $generatedHtml  = "<nav aria-label=\"Page navigation\">
                                <ul class=\"pagination\">";
            ...
            for($i = $displayedLinks['first']; $i <= $displayedLinks['last']; $i++)
            {
                ...
                {
                    $generatedHtml .= "<li class=\"page-item active\" class=\"\">
                                        <a class=\"page-link\" href=\"$path"."$i\">$i</a>
                                       </li>";
                }
                else
                {
                    $generatedHtml .= "<li class=\"page-item\" class=\"\">
                                        <a class=\"page-link\" href=\"$path"."$i\">$i</a>
                                       </li>";
                }
            }
        ...
        private  function generateArrow($firstOrLastPage, $prevOrNextPage, $char, $path)
        {
            ...
            {
                $arrow = "<li class=\"page-item\">
                            <a class=\"page-link\" href=\"$path" . "$prevOrNextPage\"> $char </a>
                          </li>";
            }
            else
            {
                $arrow = "<li class=\"page-item disabled\">
                            <a class=\"page-link\" href=\"$path" . "$prevOrNextPage\"> $char </a>
                          </li>";
            }
