<?php
    ...
    class DB
    {
        ...
        public static function getConnection()
        {
            ...
            if(self::$connectDB == false)
            {
                ...
                catch (PDOException $e)
                {
                    ...
                    error_log($e->getMessage() . PHP_EOL, 3, ROOT. '/logs/db_error.log');
                    die();
                }
            }
         ...
         * @return int id добавленной записи в случае успеха
         */
        ...
        public static function update_set($sql, $valuesArray = [])
        {
            $db = self::getConnection();
